...
export default function Cert() {
    return (
        <div className="flex flex-col items-center font-primary lg:min-h-screen">
            <h1 className="text-red-500 bg-black font-primary text-5xl text-center animate-fadeIn py-10">Certifications</h1>
            <div className="flex w-screen justify-around">
            <div className="flex flex-col border-b-2 border-transparent hover:border-green-500 py-7 trnasition-all duration-500 items-center">
