...
export default function Cert() {
    ...
    return (
        <div ref={ref} className="flex flex-col items-center font-primary min-h-screen">
            ...
            <div className="flex flex-col mb-10 animate-slideIn2sRev border-b-2 border-transparent hover:border-green-500 py-7 trnasition-all duration-500 items-center">
                <h1 className="text-3xl py-2 text-yellow-300">Front End Certification</h1>
                <Image alt="" src="/frontCert.jpg" width="464" height="144" />
            </div>
            <div className="flex mb-10 flex-col animate-slideIn2s border-b-2 border-transparent hover:border-green-500 py-7 trnasition-all duration-500 items-center">
