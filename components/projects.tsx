...
const Projects = () => {
    return (
        ...
        <div className="h-screen  bg-black border-b-2 border-green-500">
        <h1 className="text-red-500 bg-black font-primary text-5xl text-center  py-10">Projects</h1>
        <div className="bg-black text-white text-2xl pb-11 lg:flex-nowrap flex-wrap font-primary flex justify-around">
            
            <div  className="flex flex-col items-center  transition-all duration-500 gap-5 
            ...
            <div className="flex w-3/4 flex-col items-center tranistion-all duration-500 gap-5
            ...
            <div className="flex w-3/4  flex-col items-center transition-all duration-500 gap-5
            border-green-500 lg:w-1/3 lg:border-transparent border-b-2 p-2 hover:border-green-500">
