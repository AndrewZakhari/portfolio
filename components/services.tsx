...
const Services = () => {
    ...
    return (
        <div ref={ref} id="services" className="font-primary text-white -mt-80 pb-10 lg:mt-0 flex flex-col border-b-2
         border-green-500 text-2xl md:min-h-screen lg:h-screen h-[1600px]">
            { inView &&
            <>
